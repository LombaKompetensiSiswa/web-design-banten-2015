...
if(!empty($cari)){
	...
	include("koneksi.php");
	$q=mysql_query("select b.namabarang,b.harga,b.gambar,k.idkategori,t.idtoko,t.namatoko from barang b, kategori k, toko t where (t.idtoko=b.idtoko) and (k.idkategori=b.idkategori) order by idbarang desc") or die(mysql_error());
      ...
      <tr>
        ...
        <td valign="top"><table width="400" border="0" cellspacing="8" cellpadding="8">
		  ...
		  while($data=mysql_fetch_array($q)){
			  ?>
            <td><a href="penjualan/detail-penjualan.php?id=<?php echo $data['idbarang']."& idtoko=".$data['idtoko'];?>"><img src="<?php echo $data['gambar'];?>" width="200px" height="200px" /></a><br /><?php echo $data['namabarang'];?>||<?php echo $data['harga'];?></td>
          <?php
		  if($i % 3==0){
			  echo "</tr><tr>";
		  }

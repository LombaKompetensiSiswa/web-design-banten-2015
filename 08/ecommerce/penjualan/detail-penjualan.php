...
if(!isset($_SESSION['member'])){
	...
	alert("Untuk Belanja, Silahkan Login Terlebih Dahulu");
...
@$cari=$_POST['cari'];
if(!empty($cari)){
	$q=mysql_query("select b.idbarang,b.namabarang,b.harga,b.gambar,k.idkategori,t.idtoko,t.namatoko,p.idbarang,p.jumlah from barang b, kategori k, toko t, pembelian p where (t.idtoko=b.idtoko) and (k.idkategori=b.idkategori) and (b.idbarang=p.idbarang) and (p.idbarang='$id') and namabarang like '%$cari%'") or die(mysql_error());

}else{
	include("../koneksi.php");
	$id=$_GET['id'];
	$idtoko=$_GET['idtoko'];
	$q=mysql_query("select b.idbarang,b.namabarang,b.harga,b.gambar,k.idkategori,t.idtoko,t.namatoko,p.idbarang,p.jumlah from barang b, kategori k, toko t, pembelian p where (t.idtoko=b.idtoko) and (k.idkategori=b.idkategori) and (b.idbarang=p.idbarang) and (p.idbarang='$id')") or die(mysql_error());
...
<body bgcolor="#F4F4F4">
 <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" id="body">
  ...
  <tr>
    ...
    <td valign="top"><table width="249" border="0" cellspacing="0" cellpadding="0" background="../bahan/bg.jpg">
      <tr>
        <td valign="top"><form id="form2" name="form2" method="post" action="../member/proses-login.php">
          <table width="251" height="121" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td height="49" align="center"><label for="username2"></label>
                <input name="username" type="text" class="login" id="username2" placeholder="User Name" /></td>
            </tr>
            <tr>
              <td height="48" align="center"><label for="password2"></label>
                <input name="password" type="password" class="login" id="password2" placeholder="Pssword" /></td>
            </tr>
            <tr>
      ...
      <tr>
        <td valign="top"><p><a href="../kategori.php" class="box">&rarr; Pakaian</a></p>
          <p><a href="../kategori.php" class="box">&rarr; Komputer</a></p>
          <p><a href="../kategori.php" class="box">&rarr; Kamera Dan Video</a></p></td>
      </tr>
      <tr>
        <td valign="top">&nbsp;</td>
      </tr>
    ...
    <td colspan="3" valign="top"><table width="731" height="153" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td valign="top"><table width="400" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="200"><img src="<?php echo "../".$data2['gambar'];?>" width="200px" height="200px"></td>
            <td width="200" valign="top"><?php echo $data2['namabarang'];?><br>
              <?php echo $data2['namatoko'];?><br>
              Rp.<?php echo $data2['harga'];?>
              <form id="form3" name="form3" method="post" action="proses-penjualan.php">
                <label for="idbarang"></label>
                <input type="hidden" name="idbarang" id="idbarang" value="<?php echo $id;?>" />
                <input type="hidden" name="idtoko" id="idtoko" value="<?php echo $idtoko;?>" />
                <input type="hidden" name="idmember" id="idmember" value="<?php echo $_SESSION['idmember'];?>" />
                <input type="text" name="jumlah" id="jumlah" placeholder="kuantitas Barang" />
                <br />
                <input type="submit" name="beli" id="beli" value="Beli" />
                <a href="../index.php">Batalkan Pembelian</a>
              </form></td>
          </tr>
        </table></td>
      </tr>
  ...
  <tr>
    ...
    <td valign="top"><img src="../bahan/fr.png" width="251" height="35" /></td>

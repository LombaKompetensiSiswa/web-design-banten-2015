...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" id="body2">
  <tr>
    <td width="10" height="34" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="230" align="center" bgcolor="#FFFFFF">Menu Admin</td>
    <td colspan="2" align="center" bgcolor="#FFFFFF">Edit Akun</td>
  ...
  <tr>
    ...
    <td width="339" align="center" bgcolor="#F4F4F4"><form id="form1" name="form1" method="post" action="proses-edit-akun.php">
      <table width="200" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="47"><label for="idadmin"></label>
            <input name="idadmin" type="hidden" class="login" id="idadmin" placeholder="idadmin" value="<?php echo $data['idadmin'];?>" /></td>
          </tr>
        <tr>
          <td height="48"><label for="nama"></label>
            <input name="nama" type="text" class="login" id="nama" placeholder="Nama Lengkap" value="<?php echo $data['nama'];?>"  /></td>
        </tr>
        <tr>
          <td height="48"><label for="email"></label>
            <input name="email" type="text" class="login" id="email" placeholder="Email" value="<?php echo $data['email'];?>"  /></td>
        </tr>
        <tr>
          <td height="46"><label for="username"></label>
            <input name="username" type="text" class="login" id="username" placeholder="Username" value="<?php echo $data['username'];?>"  /></td>
        </tr>
        <tr>

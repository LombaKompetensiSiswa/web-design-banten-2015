...
if(!isset($_SESSION['toko'])){
	...
	$id=$_GET['id'];
	$toko=$_SESSION['toko'];
	$q=mysql_query("select * from barang where idbarang='$id'");
...
<table width="772" height="448" border="0" align="center" cellpadding="0" cellspacing="0" id="body2">
  <tr>
    ...
    <td width="229" align="center" bgcolor="#FFFFFF"><strong>Menu Admin</strong></td>
    <td width="11" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="338" align="center" bgcolor="#FFFFFF"><strong>Edit Barang</strong></td>
  ...
  <tr>
    ...
    <td align="center" valign="top"><form id="form1" name="form1" method="post" action="proses-edit-barang.php" enctype="multipart/form-data">
      <table width="200" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><label for="idbarang"></label>
            <input type="hidden" name="idbarang" id="idbarang" value="<?php echo $data['idbarang'];?>" /></td>
        </tr>
        <tr>
          <td><label for="namabarang"></label>
            <input name="namabarang" type="text" class="login" id="namabarang" placeholder="Nama Barang" value="<?php echo $data['namabarang'];?>"  /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><label for="harga"></label>
            <input name="harga" type="text" class="login" id="harga" placeholder="Harga Barang"  value="<?php echo $data['harga'];?>"  /></td>
        </tr>
        <tr>
          <td><label for="deskripsi"></label>
            <textarea name="deskripsi" id="deskripsi" cols="45" rows="5" placeholder="Deskripsi Barang" ><?php echo $data['deskripsi'];?> </textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><label for="stok"></label>
            <input name="stok" type="text" class="login" id="stok"  placeholder="Stok Barang" value="<?php echo $data['stok'];?>"  /></td>
        </tr>
        <tr>
          <td><input type="submit" name="input" id="input" value="Update Barang" /></td>
        </tr>
      </table>
    </form></td>
    <td bgcolor="#FFFFFF">&nbsp;</td>

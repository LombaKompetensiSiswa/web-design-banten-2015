  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="5">
    ...
    <?php do { ?>
      <tr>
        ...
        <a href="hapus_user.php?id=<?php echo $row_pengguna['id']; ?>"><input onClick="return confirm('Informasi user akan hilang! Lanjutkan')" name="button2" type="button" class="merah" id="hapus" value="Hapus"></a></td>
      </tr>
...
<tr>
      ...
      <td> Sebelumnya</td>
      <td>Selanjutnya</td>
      <td><a href="daftar2.php"><input name="button3" type="submit" class="hijau" id="button2" value="Tambah Pengguna"></a></td>
    </tr>
  </table>
</div>
<script type="text/javascript">

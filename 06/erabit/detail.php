...
<div id="apDiv1">
  <h1>Terima Kasih</h1>
  <p>Telah ditambahkan ke keranjang</p>
  <p>&nbsp;</p>
...
<div id="konten">
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="10">
    ...
    <tr>
      ...
      <form id="cartform">
        <input name="pembeli" type="hidden" id="pembeli" value="<?php echo $row_session['email']; ?>">
        <input name="namabarang" type="hidden" id="namabarang" value="<?php echo $row_detail['namabarang']; ?>">
<input name="harga" type="hidden" id="harga" value="<?php echo $row_detail['harga']; ?>">
<input type="submit" name="button2" id="carting" value="TAMBAH KE CART"><input name="banyak" type="number" id="numb" placeholder="Banyak Barang" ></form>
          <?php } // Show if recordset not empty ?>
        <?php if ($totalRows_session == 0) { // Show if recordset empty ?>

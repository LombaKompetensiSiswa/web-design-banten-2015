...
<div id="dasbor">
  <table width="100%" border="1" cellspacing="0" cellpadding="5">
    <tr>
      <td colspan="6" align="center" bgcolor="#339999"><strong>DATA PRODUK</strong></td>
    </tr>
    <tr>
      <td width="9%" align="center" bgcolor="#339999"><strong>ID</strong></td>
      <td width="17%" align="center" bgcolor="#339999"><strong>Nama Produk</strong></td>
      <td width="25%" align="center" bgcolor="#339999"><strong>Kategori</strong></td>
      <td width="15%" align="center" bgcolor="#339999"><strong>Harga</strong></td>
      <td width="9%" align="center" bgcolor="#339999"><strong>Foto</strong></td>
      <td width="25%" align="center" bgcolor="#339999"><strong>Pilihan</strong></td>
    </tr>
    <?php do { ?>
      <tr>
        <td><?php echo $row_produk['id']; ?></td>
        <td><?php echo substr($row_produk['namabarang'],0,20); ?></td>
        <td><?php echo $row_produk['kategori']; ?></td>
        <td><?php echo $row_produk['harga']; ?></td>
        <td><img width="100%" src="aplod/<?php echo $row_produk['id']; ?>.jpg"></td>
        <td align="center"><a target="_blank" href="aksi_foto.php?id=<?php echo $row_produk['id']; ?>"><input name="button" type="button" class="hijau" id="button" value="Tambah Foto"></a>
          <a href="hapus_produk.php?id=<?php echo $row_produk['id']; ?>"><input onClick="return confirm('Informasi user akan hilang! Lanjutkan')" name="button2" type="button" class="merah" id="hapus" value="Hapus"></a></td>
      </tr>

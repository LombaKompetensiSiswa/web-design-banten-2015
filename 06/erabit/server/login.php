...
<div id="konten">
  <form name="form2" method="POST" action="<?php echo $loginFormAction; ?>">
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
      <tr>
        <td colspan="2" align="center"><h2>LOGIN SEBAGAI PENGGUNA</h2></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="submit" name="button2" id="button2" value="LOGIN SEKARANG">
        <button onClick="history.go(-1);">KEMBALI</button></td>
      </tr>
    </table>
  </form>
  <p>&nbsp;</p>

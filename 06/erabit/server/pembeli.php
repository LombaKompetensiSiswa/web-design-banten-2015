...
mysql_select_db($database_koneksi, $koneksi);
$query_pengguna = "SELECT * FROM cart ORDER BY id DESC";
...
<div id="dasbor">
  <table width="100%" border="1" cellspacing="0" cellpadding="5">
    <tr>
      <td colspan="6" align="center" bgcolor="#339999"><strong>DATA PENGGUNA</strong></td>
    </tr>
    <tr>
      <td width="3%" align="center" bgcolor="#339999"><strong>ID</strong></td>
      <td width="37%" align="center" bgcolor="#339999"><strong>Nama Pembeli</strong></td>
      <td width="20%" align="center" bgcolor="#339999"><strong>Banyak</strong></td>
      <td width="20%" align="center" bgcolor="#339999"><strong>Harga</strong></td>
      <td width="20%" align="center" bgcolor="#339999"><strong>Konfirmasi</strong></td>
      <td width="20%" align="center" bgcolor="#339999"><strong>Pilihan</strong></td>
    </tr>
    <?php do { ?>
      <tr>
        <td><?php echo $row_pengguna['id']; ?></td>
        <td><?php echo $row_pengguna['pembeli']; ?></td>
        <td><?php echo $row_pengguna['banyak']; ?></td>
        <td><?php echo $row_pengguna['harga']; ?></td>
        <td><?php echo $row_pengguna['Konfirmasi']; ?></td>
        <td align="center"><input name="button" type="button" class="hijau" id="button" value="Konfirmasi"></td>
      </tr>

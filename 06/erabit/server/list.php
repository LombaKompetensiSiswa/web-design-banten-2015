...
if (isset($_GET['kategori'])) {
  $colname_barang = $_GET['kategori'];
}
mysql_select_db($database_koneksi, $koneksi);
$query_barang = sprintf("SELECT * FROM produk WHERE kategori = %s", GetSQLValueString($colname_barang, "text"));
...
<div id="konten">
  <div id="rightbar">
    <h1>Kategori : <?php echo $row_barang['kategori']; ?></h1>
    <?php do { ?>
      <div class="produk">

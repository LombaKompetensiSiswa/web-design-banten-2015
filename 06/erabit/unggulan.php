...
<div id="konten">
  ...
  <div class="produk">
    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="226" align="center" valign="middle" bgcolor="#FFFFFF"><img src="aplod/<?php echo $row_barang['id']; ?>.jpg" alt="" height="90%"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="21" align="center" valign="middle" bgcolor="#CCCCCC"><a href="detail.php?id=<?php echo $row_barang['id']; ?>">
